...
public class ProfessorServlet extends HttpServlet {
	 private static final long serialVersionUID = 1L;
	    ...
	    protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        switch (action) {
	            case "listar":
	                listarProfessor(request, response);
	                break;
	            case "inserir":
	                adicionarProfessor(request, response);
	                break;
	            case "editar":
	    ...
	    private void listarProfessor(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
	        List<Professor> listaProfessor = professorDAO.getTodosProfessores();
	    ...
	    private void adicionarProfessor(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
